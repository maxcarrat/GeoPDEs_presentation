...
\node[inner sep=0pt, anchor=west] (B0e0) at (MLe0.east) {\input{pictures/basis/flathierarchy/multiLevelBasis1D.B0e0.tikz}};%
...
\tikz[overlay, remember picture, visible on=<2>] {%
	...
	\node[inner sep=0pt, anchor=west] (B0e1) at (MLe1.east) {\input{pictures/basis/flathierarchy/multiLevelBasis1D.B0e1.tikz}};%
...
\tikz[overlay, remember picture, visible on=<3>] {%
	...
	\node[inner sep=0pt, anchor=west] (B0e2) at (MLe2.east) {\input{pictures/basis/flathierarchy/multiLevelBasis1D.B0e2.tikz}};%
...
\tikz[overlay, remember picture, visible on=<4>] {%
	...
	\node[inner sep=0pt, anchor=west] (B0e3) at (MLe3.east) {\input{pictures/basis/flathierarchy/multiLevelBasis1D.B0e3.tikz}};%
